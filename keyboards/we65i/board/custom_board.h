...
#define GPIO(port, pin) (((port) << 5) | ((pin) & 0x1F))
    ...
    #define PIN29   GPIO(0,9)      // 29 - P0.09 (LED_CAP)
    #define PIN30   GPIO(0,10)     // 30 - P0.10 (CHARGE_STAT)
    ...
    #define PIN24   GPIO(0,24)     // 24 - P0.24 (rA)
    #define PIN25   GPIO(0,13)     // 25 - P0.13 (rB)
    #define PIN26   GPIO(0,10)     // 28 - P0.10 (CHARGE_CTRL)
    #define PIN27   GPIO(0,9)      // 30 - P0.09 (CHARGE_STAT)
    #define PIN28   GPIO(0,26)     // 29 - P0.26 (LED_CAP)
    #define PIN29   GPIO(0,8)      // 29 - P0.08 (LED_RED)
    ...
    #define LED_RED  PIN29

    #define VDIV_PIN PIN2
    #define USE_BATTERY_PIN VDIV_PIN
    #define PIN_CHARGE_CTRL PIN26
    #define PIN_CHARGE_STAT PIN27
    ...
    #define USE_BATTERY_PIN VDIV_PIN
    #define PIN_CHARGE_CTRL PIN28
    #define PIN_CHARGE_STAT PIN29
    #define PIN_CHARGE_REV
    #define PIN_RGB_CTRL_VCC PIN26
