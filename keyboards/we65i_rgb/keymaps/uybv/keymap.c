...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [0] = LAYOUT_67_ansi(
        ...
        RGBRST,RGB_TOG,RGB_MOD,RGB_RMOD,KC_4,KC_5,KC_6,KC_7,KC_8,KC_9,KC_0,KC_MINS,KC_EQL,KC_BSPC,KC_MUTE,
   ...
   */
    [1] = LAYOUT_67_ansi(
        ...
        DEVICE_ID,DEL_ID0,DEL_ID1,DEL_ID2,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DELBNDS,KC_PGUP,KC_NO,
        KC_NO,KC_NO,KC_NO,ENT_SLP,KC_NO,KC_TRNS,KC_HOME,KC_PGDN,KC_END
    )
};
