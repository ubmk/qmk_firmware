...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
    [2] = LAYOUT_68_ansi(
        ENT_SLP,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,DELBNDS,BATT_LV,
        BLE_SEL,DEL_ID0,DEL_ID1,DEL_ID2,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,USB_SEL,KC_NO,
