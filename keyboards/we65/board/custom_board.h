...
#define GPIO(port, pin) (((port) << 5) | ((pin) & 0x1F))
...
#elif defined(WE65_V2_3)

    #define PIN2    GPIO(0,5)      //  2 - P0.05 (VDIV)
    #define PIN3    GPIO(1,9)      //  3 - P1.09 (LED_BLUE)
    #define PIN4    GPIO(0,12)     //  4 - P0.12 (LED1)
    #define PIN5    GPIO(0,4)      //  5 - P0.04 (LED2)
    #define PIN6    GPIO(0,8)      //  6 - P0.08 (LED3)
    #define PIN7    GPIO(0,15)     //  7 - P0.15 (row0)
    #define PIN8    GPIO(0,17)     //  8 - P0.17 (row1)
    #define PIN9    GPIO(0,20)     //  9 - P0.20 (row2)
    #define PIN10   GPIO(0,22)     // 10 - P0.22 (row3)
    ...
    #define PIN18   GPIO(0,30)     // 18 - P0.30 (col2)
    #define PIN19   GPIO(1,11)     // 19 - P1.11 (col3)
    #define PIN20   GPIO(1,13)     // 20 - P1.13 (col4)
    #define PIN21   GPIO(0,28)     // 21 - P0.28 (col5)
    #define PIN22   GPIO(0,3)      // 22 - P0.03 (col6)
    #define PIN23   GPIO(1,10)     // 23 - P1.10 (col7)
    #define PIN24   GPIO(0,26)     // 24 - P0.26 (rA)
    #define PIN25   GPIO(0,6)      // 25 - P0.06 (rB)
    #define PIN26   GPIO(0,10)     // 26 - P0.10 (RGB_CTRL)
    #define PIN27   GPIO(0,9)      // 27 - P0.09 (RGB)
    ...
    #define PIN_RGB_DATA PIN27
    #define PIN_RGB_CTRL_GND PIN26

#elif defined(WE65_V2_5)

    #define PIN2    GPIO(0,5)      //  2 - P0.05 (VDIV)
    #define PIN3    GPIO(0,9)      //  3 - P0.09 (LED_BLUE)
    #define PIN4    GPIO(0,8)      //  4 - P0.08 (LED1)
    #define PIN5    GPIO(0,6)      //  5 - P0.06 (LED2)
    #define PIN6    GPIO(0,10)     //  6 - P0.10 (LED3)
    #define PIN7    GPIO(0,15)     //  7 - P0.15 (row0)
    #define PIN8    GPIO(0,17)     //  8 - P0.17 (row1)
    #define PIN9    GPIO(0,20)     //  9 - P0.20 (row2)
    #define PIN10   GPIO(0,22)     // 10 - P0.22 (row3)
    ...
    #define PIN22   GPIO(0,3)      // 22 - P0.03 (col6)
    #define PIN23   GPIO(1,10)     // 23 - P1.10 (col7)
    #define PIN24   GPIO(0,12)     // 24 - P0.12 (rA)
    #define PIN25   GPIO(0,7)      // 25 - P0.07 (rB)
    #define PIN26   GPIO(0,26)     // 26 - P0.26 (RGB_CTRL)
    #define PIN27   GPIO(1,9)      // 27 - P1.09 (RGB)
    #define PIN28   GPIO(0,24)     // 28 - P0.24 (CHARGE_CTRL)
    #define PIN29   GPIO(0,13)     // 29 - P0.13 (CHARGE_STAT)
